...
This konnector retrieves your bills/certificates of subscription from the [RTM (Régie des Transports Métropolitains)](http://www.rtm.fr) and it will tie them to the according bank operations.
...
```javascript
{
  ...
  "fields": {"cardNumber":"0000000000", "dob":"24/01/1969"}
}
```

Where :
* cardNumber is your Transpass card number
* dob is... well, the birth date of the card bearer (DD/MM/YYY format)
...
The lead maintainers for this konnector is [@lpoujol](https://github.com/lpoujol)
...
License
-------
cozy-konnector-rtm is developed by Ludovic Poujol and distributed under the [AGPL v3 license][agpl-3.0].
